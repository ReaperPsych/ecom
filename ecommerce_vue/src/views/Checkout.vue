    ...
    <div class="page-checkout">
        <div class="columns is-multiline">
            ...
            <div class="column is-12 box">
                ...
                <hr>
                    <button class="button is-dark" @click="submitForm">Pay with Visa</button>
                </template>
            </div>
        </div>
    </div>
...
export default{
    ...
    methods:{
        ...
        submitForm(){
            ...
            if(this.phone === ''){
                this.errors.push('This phone field is missing')
            }
            if(this.address === ''){
                this.errors.push('This address field is missing')
            }
            if(this.zipcode === ''){
                this.errors.push('This zipcode field is missing')
            }
            if(this.place === ''){
